...
fn render_domain_part(connection: &mut MockConnection, graph: &InferenceGraph) -> String {
...
fn render_relation_part(connection: &mut MockConnection, graph: &InferenceGraph) -> String {
    let mut buffer = format!(
        r#"
        <div class='section_header'>
            Relations
...
fn render_implication_part(connection: &mut MockConnection, graph: &InferenceGraph) -> String {
    let mut buffer = format!(
        r#"
        <div class='section_header'>
            Implication Factors
...
fn render_experiment_parts(connection: &mut MockConnection, graph: &InferenceGraph) -> String {
    format!(
        r#"
        {domain_part}
        {relation_part}
